...
we ask whether the geometric properties of latent space and
data manifold interact with each other.
Specifically, we visualize the effect of dimensionality and
connectivity of latent space and data manifold
using specially designed synthetic experiments.
\end{abstract}
