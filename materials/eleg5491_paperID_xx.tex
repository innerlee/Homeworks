...
\title{Paper Instructions for ELEG5491 Final Project 2017}
...
\def\PaperID{1000} % *** Enter your assigned Paper ID here
...
Add the citations in the \texttt{eleg5491.bib} file. 
...
\clearpage
\textcolor{blue}{STOP. The maximum length of the paper is four.} 

A 5-th page can include references \textit{only}. However, we \textit{\textbf{strongly}} suggest you to 
write all contents including references within four pages.
